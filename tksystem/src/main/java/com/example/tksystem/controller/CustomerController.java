...
public class CustomerController {
	 ...
	 * 登録を実行
	 * 
	 * @param customer顧客画面入力値
	 * @param result 入力チェック結果
	 * @return 遷移先
	 */
	@PostMapping(value="/create")
	public String create(@Validated @ModelAttribute(MODEL_ATTRIBUTE_NAME) Customer customer,BindingResult result) {
	...
	public String update(@Validated @ModelAttribute(MODEL_ATTRIBUTE_NAME) Customer customer,BindingResult result) {
